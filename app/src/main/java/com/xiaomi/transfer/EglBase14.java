...
public class EglBase14 extends EglBase {
    ...
    public EglBase14(EGLContext share) {

        eglDisplay = getEglDisplay();
        eglConfig = getEglConfig(eglDisplay, CONFIG_PLAIN);
        synchronized (lock) {
            int[] contextAttributes = {EGL14.EGL_CONTEXT_CLIENT_VERSION, 3, EGL14.EGL_NONE};
            eglContext = EGL14.eglCreateContext(eglDisplay, eglConfig, share, contextAttributes, 0);
            Log.i("uuuuuuuuu", "  ddd create content egl content " + eglContext  + " share " + share);
...
//    }
    ...
    private static EGLContext createEglContext(Context sharedContext, EGLDisplay eglDisplay, EGLConfig eglConfig) {
        ...
        synchronized (lock) {
            ...
            Log.i("uuuuuuuuu", " shared content " + sharedContext);
            if (sharedContext != null) {
                Log.i("uuuuuuuuu", " shared content egl content " + sharedContext.eglContext );
            }
            Log.i("uuuuuuuuu", " create content egl content " + eglContext );
    ...
    private void checkIsNotReleased() {
        if (eglDisplay == EGL14.EGL_NO_DISPLAY || eglContext == EGL14.EGL_NO_CONTEXT
            ...
            if (eglContext == EGL14.EGL_NO_CONTEXT) {
                Log.i("info" , "cccccccccc");
            }
            if (eglConfig == null) {
                Log.i("info" , " nnnn cccccccccc");
            }
    ...
    public void setPresentTime(long nsecs) {
